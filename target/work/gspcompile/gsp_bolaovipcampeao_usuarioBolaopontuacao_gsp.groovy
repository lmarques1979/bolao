...
class gsp_bolaovipcampeao_usuarioBolaopontuacao_gsp extends GroovyPage {
...
printHtmlPart(11)
invokeTag('image','asset',28,['height':(params.alturaimagens),'width':(params.larguraimagens),'src':(usuarioBolaoInstance?.bolao?.imagem),'title':(usuarioBolaoInstance?.bolao?.descricao)],-1)
printHtmlPart(6)
}
printHtmlPart(12)
...
printHtmlPart(20)
invokeTag('image','asset',60,['height':("35"),'width':("35"),'src':(resenha?.usuariobolao?.usuario?.imagem),'title':(resenha?.usuariobolao?.usuario?.buscaNome(resenha?.usuariobolao?.usuario))],-1)
printHtmlPart(21)
...
printHtmlPart(26)
invokeTag('image','asset',109,['height':(params.alturaimagensthumbs),'width':(params.larguraimagensthumbs),'src':(usuariobolao[0].imagem),'title':(usuariobolao[0].username)],-1)
printHtmlPart(37)
}
else {
printHtmlPart(26)
invokeTag('image','asset',112,['height':(params.alturaimagensthumbs),'width':(params.larguraimagensthumbs),'src':("noimage.jpg"),'title':(usuariobolao[0].username)],-1)
printHtmlPart(37)
}
printHtmlPart(38)
...
public static final long LAST_MODIFIED = 1405897755000L
