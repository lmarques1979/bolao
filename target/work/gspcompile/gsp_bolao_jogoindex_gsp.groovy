...
class gsp_bolao_jogoindex_gsp extends GroovyPage {
...
printHtmlPart(41)
invokeTag('set','g',134,['var':("rodadaanterior"),'value':(rodadaatual)],-1)
printHtmlPart(23)
invokeTag('set','g',135,['var':("datajogoanterior"),'value':(datajogoatual)],-1)
printHtmlPart(21)
i++
}
}
printHtmlPart(42)
invokeTag('paginate','g',140,['total':(jogoInstanceCount ?: 0),'params':(params)],-1)
printHtmlPart(43)
})
