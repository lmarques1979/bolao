...
class gsp_bolaovipcampeao_configuracaoedit_gsp extends GroovyPage {
...
printHtmlPart(4)
invokeTag('message','g',13,['code':("configuracao.edit.label")],-1)
printHtmlPart(5)
...
invokeTag('eachError','g',21,['bean':(configuracaoInstance),'var':("error")],3)
printHtmlPart(15)
})
invokeTag('hasErrors','g',23,['bean':(configuracaoInstance)],2)
printHtmlPart(8)
createTagBody(2, {->
printHtmlPart(16)
invokeTag('hiddenField','g',25,['name':("version"),'value':(configuracaoInstance?.version)],-1)
printHtmlPart(17)
...
invokeTag('form','g',32,['url':([resource:configuracaoInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(20)
})
