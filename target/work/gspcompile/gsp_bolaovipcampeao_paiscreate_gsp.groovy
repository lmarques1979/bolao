...
class gsp_bolaovipcampeao_paiscreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/pais/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'pais.label', default: 'Pais'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
printHtmlPart(4)
createTagBody(2, {->
invokeTag('message','g',12,['code':("list.pais.label")],-1)
})
...
invokeTag('eachError','g',24,['bean':(paisInstance),'var':("error")],3)
printHtmlPart(16)
})
invokeTag('hasErrors','g',26,['bean':(paisInstance)],2)
printHtmlPart(9)
createTagBody(2, {->
printHtmlPart(17)
...
invokeTag('form','g',34,['url':([resource:paisInstance, action:'save'])],2)
printHtmlPart(20)
})
