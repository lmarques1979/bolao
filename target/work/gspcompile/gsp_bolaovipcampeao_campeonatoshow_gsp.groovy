...
class gsp_bolaovipcampeao_campeonatoshow_gsp extends GroovyPage {
...
if(true && (campeonatoInstance.imagem)) {
printHtmlPart(17)
invokeTag('image','asset',39,['height':(params.alturaimagens),'width':(params.larguraimagens),'src':(campeonatoInstance.imagem),'title':(campeonatoInstance.descricao)],-1)
printHtmlPart(18)
}
printHtmlPart(19)
}
...
public static final long LAST_MODIFIED = 1405788537000L
