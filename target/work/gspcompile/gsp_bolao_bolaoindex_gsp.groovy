...
printHtmlPart(22)
invokeTag('image','asset',74,['height':(params.alturaimagens),'width':(params.larguraimagens),'src':("bolao/${bolaoInstance.descricao}/${bolaoInstance.imagem}"),'title':(bolaoInstance.descricao)],-1)
printHtmlPart(28)
}
printHtmlPart(29)
