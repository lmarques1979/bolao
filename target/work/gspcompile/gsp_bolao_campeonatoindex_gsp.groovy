...
printHtmlPart(16)
invokeTag('image','asset',42,['height':(params.alturaimagens),'width':(params.larguraimagens),'src':("campeonatos/${campeonatoInstance.descricao}/${campeonatoInstance.imagem}"),'title':(campeonatoInstance.descricao)],-1)
printHtmlPart(17)
}
printHtmlPart(18)
