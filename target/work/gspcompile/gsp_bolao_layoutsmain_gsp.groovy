...
printHtmlPart(8)
invokeTag('image','asset',96,['class':("avatarmain"),'height':("120"),'width':("120"),'src':("usuarios/${sec.loggedInUserInfo(field: 'username')}/${sec.loggedInUserInfo(field: 'imagem')}"),'title':(sec.loggedInUserInfo(field: 'primeironome') + ' ' + sec.loggedInUserInfo(field: 'sobrenome'))],-1)
printHtmlPart(34)
}
else {
printHtmlPart(8)
createTagBody(4, {->
printHtmlPart(17)
invokeTag('image','asset',100,['class':("avatarmain"),'height':("120"),'width':("120"),'src':("usuarios/noimage.jpg"),'title':(sec.loggedInUserInfo(field: 'username'))],-1)
printHtmlPart(8)
})
invokeTag('ifLoggedIn','sec',101,[:],4)
printHtmlPart(34)
}
printHtmlPart(38)
}
...
createTagBody(2, {->
printHtmlPart(8)
invokeTag('message','g',110,['code':("regulamentogeral.message")],-1)
printHtmlPart(38)
})
invokeTag('link','g',111,['controller':("diversos"),'action':("pontuacao")],2)
printHtmlPart(41)
createTagBody(2, {->
printHtmlPart(8)
invokeTag('message','g',113,['code':("contato.message")],-1)
printHtmlPart(38)
})
invokeTag('link','g',114,['controller':("diversos"),'action':("contato")],2)
printHtmlPart(42)
invokeTag('message','g',118,['code':("spinner.alt"),'default':("Loading&hellip;")],-1)
printHtmlPart(43)
})
