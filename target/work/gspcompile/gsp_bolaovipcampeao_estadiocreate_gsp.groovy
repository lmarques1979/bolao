...
class gsp_bolaovipcampeao_estadiocreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/estadio/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'estadio.label', default: 'Estadio'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
printHtmlPart(4)
createTagBody(2, {->
invokeTag('message','g',12,['code':("estadio.list.label")],-1)
})
...
invokeTag('eachError','g',24,['bean':(estadioInstance),'var':("error")],3)
printHtmlPart(16)
})
invokeTag('hasErrors','g',26,['bean':(estadioInstance)],2)
printHtmlPart(9)
createTagBody(2, {->
printHtmlPart(17)
...
invokeTag('form','g',34,['url':([resource:estadioInstance, action:'save'])],2)
printHtmlPart(20)
})
