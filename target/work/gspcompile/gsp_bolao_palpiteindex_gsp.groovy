...
class gsp_bolao_palpiteindex_gsp extends GroovyPage {
...
printHtmlPart(53)
invokeTag('set','g',159,['var':("rodadaanterior"),'value':(rodadaatual)],-1)
printHtmlPart(54)
invokeTag('set','g',160,['var':("datajogoanterior"),'value':(datajogoatual)],-1)
printHtmlPart(28)
i++
}
}
...
if(true && (filtrodatapalpite!='3')) {
printHtmlPart(25)
invokeTag('actionSubmit','g',167,['id':("botaopalpitesalvar"),'action':("save"),'value':(message(code: 'button.create.label', default: 'Update'))],-1)
printHtmlPart(26)
}
printHtmlPart(56)
})
invokeTag('form','g',173,['url':([action:'save',controller:'palpite']),'method':("POST")],3)
printHtmlPart(57)
invokeTag('paginate','g',175,['total':(palpitesList ?: 0)],-1)
printHtmlPart(58)
invokeTag('javascript','asset',178,['src':("filtrochange.js")],-1)
printHtmlPart(9)
}
printHtmlPart(59)
})
