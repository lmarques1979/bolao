...
class gsp_bolaovipcampeao_palpiteedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/palpite/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',27,['bean':(palpiteInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(palpiteInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(palpiteInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:palpiteInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
