...
class gsp_bolao_palpitepalpiteusuario_gsp extends GroovyPage {
...
printHtmlPart(49)
invokeTag('set','g',146,['var':("rodadaanterior"),'value':(rodadaatual)],-1)
printHtmlPart(50)
invokeTag('set','g',147,['var':("datajogoanterior"),'value':(datajogoatual)],-1)
printHtmlPart(15)
i++
}
}
printHtmlPart(51)
invokeTag('paginate','g',152,['total':(palpitesList ?: 0)],-1)
printHtmlPart(52)
})
invokeTag('captureBody','sitemesh',155,[:],1)
printHtmlPart(53)
invokeTag('javascript','asset',158,['src':("filtrochange.js")],-1)
printHtmlPart(54)
}
