...
class gsp_bolao_jogofiltro_gsp extends GroovyPage {
...
printHtmlPart(42)
invokeTag('set','g',135,['var':("rodadaanterior"),'value':(rodadaatual)],-1)
printHtmlPart(23)
invokeTag('set','g',136,['var':("datajogoanterior"),'value':(datajogoatual)],-1)
printHtmlPart(21)
i++
}
}
printHtmlPart(43)
invokeTag('paginate','g',141,['total':(jogoInstanceCount ?: 0),'params':(params)],-1)
printHtmlPart(44)
})
