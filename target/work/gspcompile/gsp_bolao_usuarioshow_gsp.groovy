...
if(true && (usuarioInstance.imagem)) {
printHtmlPart(11)
invokeTag('image','asset',26,['height':(params.alturaimagens),'width':(params.larguraimagens),'src':("usuarios/${usuarioInstance.username}/${usuarioInstance.imagem}"),'title':(usuarioInstance.username)],-1)
printHtmlPart(12)
}
else {
printHtmlPart(11)
invokeTag('image','asset',29,['height':(params.alturaimagens),'width':(params.larguraimagens),'src':("usuarios/noimage.jpg"),'title':(usuarioInstance.username)],-1)
printHtmlPart(12)
}
printHtmlPart(13)
}
