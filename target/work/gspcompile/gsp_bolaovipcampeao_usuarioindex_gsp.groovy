...
class gsp_bolaovipcampeao_usuarioindex_gsp extends GroovyPage {
...
printHtmlPart(10)
invokeTag('sortableColumn','g',30,['property':("timecoracao"),'title':(message(code: 'usuario.timecoracao.label', default: 'Time de Coração'))],-1)
printHtmlPart(10)
invokeTag('sortableColumn','g',31,['property':("enabled"),'title':(message(code: 'usuario.enabled.label', default: 'Ativo'))],-1)
printHtmlPart(12)
loop:{
int i = 0
...
invokeTag('link','g',38,['action':("show"),'id':(usuarioInstance.id)],3)
printHtmlPart(15)
...
printHtmlPart(16)
invokeTag('image','asset',47,['height':(params.alturaimagensthumbs),'width':(params.larguraimagensthumbs),'src':(usuarioInstance.imagem),'title':(usuarioInstance.username)],-1)
printHtmlPart(17)
}
else {
printHtmlPart(16)
invokeTag('image','asset',50,['height':(params.alturaimagensthumbs),'width':(params.larguraimagensthumbs),'src':("noimage.jpg"),'title':(usuarioInstance.username)],-1)
printHtmlPart(17)
}
printHtmlPart(18)
if(true && (usuarioInstance.timecoracao)) {
printHtmlPart(16)
invokeTag('image','asset',55,['src':("bandeiras/24/${usuarioInstance.timecoracao.imagem}"),'title':(usuarioInstance.timecoracao.descricao)],-1)
printHtmlPart(17)
}
printHtmlPart(19)
invokeTag('formatBoolean','g',60,['boolean':(usuarioInstance?.enabled)],-1)
printHtmlPart(20)
i++
}
}
...
public static final long LAST_MODIFIED = 1405788251000L
