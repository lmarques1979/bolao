...
class gsp_bolao_jogoshow_gsp extends GroovyPage {
...
printHtmlPart(36)
createTagBody(3, {->
invokeTag('message','g',128,['code':("button.edit.label"),'default':("Edit")],-1)
})
invokeTag('link','g',128,['class':("edit"),'action':("edit"),'resource':(jogoInstance)],3)
printHtmlPart(37)
...
invokeTag('form','g',131,['url':([resource:jogoInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(39)
})
