...
grails {
	mail {
	  from = "rastreadorpacotes@gmail.com"
	  host = "smtp.gmail.com"
	  port = 465
...
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'seguranca.UsuarioRegra'
grails.plugin.springsecurity.authority.className = 'seguranca.Regra'
