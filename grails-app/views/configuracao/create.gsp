...
<html>
	<head>
		...
		<title><g:message code="configuracao.create.label"/></title>
	</head>
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				<li><g:link class="list" action="index"><g:message code="configuracao.list.label"/></g:link></li>
			</ul>
		</div>
		<div id="create-configuracao" class="content scaffold-create" role="main">
			<h1><g:message code="configuracao.create.label"/></h1>
