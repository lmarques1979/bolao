...
<html>
	<head>
		...
		<title><g:message code="time.create.label"/></title>
	</head>
	<body>
		<a href="#create-time" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		
		<div id="create-time" class="content scaffold-create" role="main">
			<h1><g:message code="time.create.label"/></h1>
